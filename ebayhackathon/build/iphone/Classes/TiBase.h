...
// in simulator we redefine to format for ebayhackathon Developer console
...
{\
	NSString * exceptionName = [@"org.ebayhackathon." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ebayhackathon";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIebayhackathonNativeItemNone = -1, 
	UIebayhackathonNativeItemSpinner = -2,
	UIebayhackathonNativeItemProgressBar = -3,
	
	UIebayhackathonNativeItemSlider = -4,
	UIebayhackathonNativeItemSwitch = -5,
	UIebayhackathonNativeItemMultiButton = -6,
	UIebayhackathonNativeItemSegmented = -7,
	
	UIebayhackathonNativeItemTextView = -8,
	UIebayhackathonNativeItemTextField = -9,
	UIebayhackathonNativeItemSearchBar = -10,
	
	UIebayhackathonNativeItemPicker = -11,
	UIebayhackathonNativeItemDatePicker = -12,
	
	UIebayhackathonNativeItemInfoLight = -13,
	UIebayhackathonNativeItemInfoDark = -14,
	
	UIebayhackathonNativeItemDisclosure = -15,
	
	UIebayhackathonNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ebayhackathon instances of
