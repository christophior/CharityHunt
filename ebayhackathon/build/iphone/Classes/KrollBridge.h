...
@interface ebayhackathonObject : KrollCoverageObject {
#else
@interface ebayhackathonObject : KrollObject {
#endif
@private
...
extern NSString * ebayhackathon$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ebayhackathonObject *_ebayhackathon;
    KrollObject* console;
	BOOL shutdown;
