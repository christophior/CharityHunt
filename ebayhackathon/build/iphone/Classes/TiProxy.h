...
//Rare exceptions to indicate a bug in the _ebayhackathon code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ebayhackathon proxies.
 */
