 ...
 * Copyright (c) 2009-2011 by ebayhackathon, Inc. All Rights Reserved.
...
//@interface ebayhackathonObject : NSObject
//@end

@interface ebayhackathonObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ebayhackathonObject class]])
		{
			for (NSString *key in [[(ebayhackathonObject*)o modules] allKeys])
			{
