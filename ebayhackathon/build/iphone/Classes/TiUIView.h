...
/**
 Base class for all ebayhackathon views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ebayhackathon view hierarchy (such as wrapped iOS UIViews) was touched.
